...
{
    public class VolumeSliderMaster : BaseSlider
    {
        protected override void OnEnable()
        {
            ...
            float logValue;
            AudioController.Instance.AudioMixer.GetFloat(AudioMixerExposedParams.MasterVolume.ToString(), out logValue);
        ...
        {
            AudioController.Instance.SetMasterVolume(sliderNewValue);
            float newMixerValue;
            AudioController.Instance.AudioMixer.GetFloat(AudioMixerExposedParams.MasterVolume.ToString(), out newMixerValue);
            GameSettings.Instance.SetSetting(GameSettings.SettingsOptions.VolumeMaster, newMixerValue);
        }
    }
}
