...
namespace Players
{
    public class PlayerComputer1 : BasePlayerComputer
    {
        protected override Vector3 DefaultStrikerPosition => new Vector3(0f, 0.68f, -4.8f);

        public PlayerComputer1(PlayerSide playerSide) : base(playerSide) { }
        ...
        {
            return (puck.transform.position.z - spaceBehindPuckToStopMovingBack < striker.transform.position.z) && (striker.transform.position.z > playerMovementConstraints.ZAxisMin + striker.transform.localScale.z);
        }
        ...
        protected override void MoveBackIfPuckIsBehindYou(Puck puck, Striker striker, PlayerMovementConstraints playerMovementConstraints, float slowDownModifier)
        {
            ...
            MoveTowardsPosition(striker, striker.transform.position, new Vector3(striker.transform.position.x, striker.transform.position.y, playerMovementConstraints.ZAxisMin), slowDownModifier);
        }
    }
}
