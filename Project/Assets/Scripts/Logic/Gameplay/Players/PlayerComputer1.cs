...
namespace Players
{
    public class PlayerComputer1 : BasePlayerComputer
    {
        ...
        protected override void MoveBackIfPuckIsBehindYou(Puck puck, Striker striker, PlayerMovementConstraints playerMovementConstraints)
        {
            ...
            MoveTowardsPosition(striker, striker.transform.position, new Vector3(striker.transform.position.x, striker.transform.position.y, playerMovementConstraints.ZAxisMin));
        }
    }
}
